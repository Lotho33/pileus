...
/// Desktop server discovery: manual host entry + "retry auto-detect".
/// Probe logic mirrors the mobile screen (HTTP /pileus/info + a gRPC TCP
/// reachability check); only the presentation is a centred card.
